      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p>
            I am curently working as a private tutor, giving lessons to students in the area of 
            mathematics, physics, programming (C, Javascript) as well as information technology 
            and computer networks.
            </p>
            <p>
            Also very actively volounteering in organizations as one of my main 
          ...
          <div
            className="flex flex-col gap-12 justify-center pb-408"
            ref={experienceRef}
          >
            <motion.h1
              initial={{ x: "-300px" }}
